        ...
        messages: [
          { role: "system", content: SYSTEM },
          {
            ...
            content: [
              ...
              "Do not duplicate their wording, premise, emotional fault line, or underlying dilemma.",
              JSON.stringify(opp.similarExistingQuestions),
              "",
              "Create exactly three conviction questions engineered for immediate side-taking, emotional expression, screenshots, replies, quote-posts, and sustained debate.",
              "Do not write surveys. Do not write safe discussion prompts.",
              "Find the polarizing human conflict inside the opportunity. Put the reader inside the choice.",
            ].join("\n"),
          },
        ],
      }),
